...
Тема обсуждения - сознание и субьектность у ИИ. На прошлой дискуссии мы выяснили, что многие учёные и разрабочики ИИ считают, что существующие гигантские модели ИИ (типа ChatGPT или Dreamer) уже обладают минимальным  феноменологическим опытом, который можно назвать минимальным сознанием. Однако, обладают ли они субъектностью? Может ли вообще возникнуть субьектность у ИИ? 
Кроме этого, недавно вышла большая статья с обзором разных теоретических моделей сознания и анализом, возможно ли  сознания у ИИ. Мы обсудим эту статью и основные выводы из неё и попробуем в результате ответить, сможет ли ИИ обладать сознанием и субьектностью.
Материалы, которые рекомендуется посмотреть/прочитать перед семинаром:
...
А также прочитать вот эту большую обзорную статью по сознанию у ИИ (https://arxiv.org/pdf/2308.08708.pdf), мы ее будем обсуждать.
...
### 21 декабря 2023 17:00 мск - Самоорганизация профессиональных и экспертных сообществ на примере AGIRussia (круглый стол) - Антон Колонин, Никита Розанов, Борис Новиков, приглашаем спикеров... - уточняется
- Никита Розанов @Careviolan - "Золотое правило", или не поступай с другими так как ты не хочешь чтобы поступали с тобой
  - Может ли этика возникнуть если не ставить четких правил, а минимизировать потери соседей
  - Как понять цели другого агента не зная их
  - Конкретный алгоритм реализующий "Золотое правило" (проект с открытым кодом)
  - Недостатки такого подхода
  - https://t.me/agitopics/13994/22178
  - https://t.me/collectivei/4987
- Антон Колонин @akolonin - текучая репутация для персональных цифровых ассистентов
  - Текучая репутация - что это? https://arxiv.org/pdf/1811.08149.pdf
  - Текучая репутация как консенсус для распределенных реестров
  - Текучая репутация в онлайн группах на примере Telegram
  - Текучая репутация в Aigents (проект с открытым кодом)
  - https://t.me/agirussia/72828
- Борис Новиков
  ...
  - Ограничения для применения ИИ: тактические и стратегические задачи. Нужно отделить ИИ в виртуальном мире с выходом на человека, от его управления роботами (машинами) с изменением физического мира минуя людей в существенных для Человечества масштабах.  Военное применение и самовоспроизводство роботов - только через участие людей.
  - Темпы развития ИИ и их регулирование с использованием теории техно-гуманитарного баланса (Назаретяна)
  - Возможность отключения любого ИИ людьми, с потерями, но без вымирания человека как биологического вида.
  - Необходимость и возможность международного контроля: от экспертов к правительствам. На примере Пагуошского движения, "ядерной зимы" и МАГАТЭ.
- Юрий Бабуров @yuri_baburov
  - https://t.me/collectivei/5093 
- Игорь Пивоваров @igorpivovarov
  - https://t.me/collectivei/5095  

### 18 января 2024 17:00 мск - ... - уточняется

### 25 января 2024 17:00 мск - Семантическое представление онтологий, структуры данных и языки, унификация, интеграция и стандартизация - Валерьян Ивашенко (БГУИР) - уточняется
- https://www.bsuir.by/ru/kaf-iit/ivashenko-v-p

### 1 февраля 2024 17:00 мск - Архитектурный подход к моделированию общего ИИ - Борис Славин (профессор Финансового университета при правительстве РФ) - уточняется
- https://www.cell.com/heliyon/pdf/S2405-8440(23)01650-X.pdf

### 8 февраля 2024 17:00 мск - ... - уточняется

### 15 февраля 2024 17:00 мск - ... - уточняется

### 22 февраля 2024 17:00 мск - ... - уточняется

### 29 февраля 2024 17:00 мск - Построение сложных самоорганизующихся систем AGI из Базовых Компонентов Разума (БКР) - Виктор Артюхов - уточняется
- Тезисы:
...
### 7 марта 2024 17:00 мск - ... - уточняется

### 14 марта 2024 17:00 мск - ... - уточняется

### 21 марта 2024 17:00 мск - ... - уточняется

### 28 марта 2024 17:00 мск - ... - уточняется
