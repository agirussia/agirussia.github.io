...
- Вопросы:
  ...
  4. ИИ-ассистент — в глобальном облаке, национальном периметре или собственном оборудовании?
  5. Приватность — умерла окончательно или есть шанс или только после цивилизационной перезагрузки? 
  6. А нужна ли ли приватность в эпоху информационной тотализации и кибербезопасности?   
  7. Кто оплатит "музыку" — разработку, хостинг и поддержку ИИ-ассистента для конечного пользователя?
  8. Как взаимодействовать двум персональным агентам в борьбе людей за один ресурс?
  9. Какая этика должна быть у персональных помощников между собой и с чужими людьми?
  10. Национальный (а не корпоративный) ИИ и ИИ-ассистент - невозможность, неизбежность, или цель?
