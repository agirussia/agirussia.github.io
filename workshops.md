...
8. Видите ли вы перспективу в гибридных методах, таких как следующие а) автоматическое (ML/DL) построение онтологий, б) использование онтологий для обучения или для подготовки данных для обучения?
...
### 10 февраля - Прозрачен ли черный ящик? Можно ли извлечь знания из нейросети и если - да, то - как? - круглый стол (уточняется)

### 17-18 февраля - Открытая конференция по искусственному интеллекту OpenTalks.AI

- https://opentalks.ai/

### 24 Разбор полетов OpenTalks.AI - Игорь Пивоваров (уточняется)
