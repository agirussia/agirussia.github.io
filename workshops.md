...
### 27 марта 2025 17:00 мск - Нечеткие "знания" и "ризонеры" (продолжение семинаров 23-30 февраля) - Антон Колонин (AGIRussia, Aigents, НГУ, SingularityNET)
- [слайды](https://aigents.com/papers/2025/ontologies-webstructor-aigents-2025.pdf)

### 10 апреля 2025 17:00 мск - RAG. Примеры использования внешний памяти и источников данных для улучшения качества работы LLM - Павел Саловский (NotAIbook) уточняется
- http://notaibook.site
