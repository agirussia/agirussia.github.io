...
### 29 декабря - Философские предпосылки формирования единого языка общения (терминологии) в области ИИ - Борис Новиков 
...
### 2 февраля - ИИ для "цифровых двойнков" - уточняется
- ЦД для систем поддержки принятия решений (СППР) - Дмитрий Свириденко
- ЦД для автономого принятия решений - сценарии применения - Сергей Довгань
...
### 9 февраля - Новые приключения в интерепретируемом NLP - Антон Колонин (кандидат технических наук, ведущий специалист НГУ, основатель Aigents, архитектор SingularityNET) - уточняется - уточняется
