...
1. Нужны ли онтологии сильному ИИ и если - да, то - зачем?
2. Необходима ли работа над top-level онтологиями и онтологиями для объединения дисциплинарных моделей / знаний? Какие есть принципиальные препятствия и как они могут быть обойдены?
3. Программирование на основе онтологий - пройденный этап?
4. Стоимость поддержания/переиспользования инженерных / задачных онтологий все чаще признается неокупаемой, равно как и (бизнес-)моделирование в целом и детальное проектирование. Какой возможен выход?
5. Какие есть барьеры у существующих языков описания онтологий и куда языки будут развиваться?
6. Какие есть и могут возникнуть альтернативные способы картирования и связывания знаний?
7. Каковы перспективные способы применения онтологий: ризонеры, linking data, что еще?
8. Видите ли вы перспективу в гибридных методах, таких как: а) автоматическое (ML/DL) построение онтологий, б) использование онтологий для обучения или для подготовки данных для обучения?

### 27 января - AGI и реальный мир - взаимодействие, обучение и ответственность - Сергей Терехов, Николай Рабчевский, Владимир Смолин, модератор Игорь Пивоваров

### 3 февраля - AGI как Коллективный Интеллект? - Антон Колонин

### 10 февраля - Прозрачен ли черный ящик? Можно ли извлечь знания из нейросети и если - да, то - как? - Юрий Бабуров (уточняется)

- вытаскивание знаний из нейросети;
- компактное представление информации о работе нейросети;
- объяснения ответа нейросети и выделения характеристик срабатывания;
- какие нужны нейросети для сознательного рационального агента.

### 17-18 февраля - Открытая конференция по искусственному интеллекту OpenTalks.AI

- https://opentalks.ai/

### 24 февраля - Разбор полетов OpenTalks.AI - Игорь Пивоваров (уточняется)

### 3 марта - [Машинное обучение и AGI - одно продолжает другое или это разные вещи? - Юрий Бабуров, Антон Колонин, Владимир Смолин, модератор Дмитрий Салихов - круглый стол](https://github.com/agirussia/agirussia.github.io/wiki/%D0%9C%D0%B0%D1%88%D0%B8%D0%BD%D0%BD%D0%BE%D0%B5-%D0%BE%D0%B1%D1%83%D1%87%D0%B5%D0%BD%D0%B8%D0%B5-%D0%B8-AGI) (уточнется)

- Supervised vs Unsupervised - определения, применимость к AGI
- Насколько универсален должен быть AGI по принципам обучения? 
- Нужно ли строить AGI, отталкиваясь от универсальных принципов оптимизации (deep learning) или лучше делать это, моделируя hardwired inductive biases (мозг)?

### 10 марта - Интеллект-стек для xGI - Анатолий Левенчук (уточняется)

- https://ailev.livejournal.com/

### 17 марта - Представление процессов, сценариев и поведенческих программ - круглый стол (уточнется)  

### 24 марта - Вопросы практического AGI - Юрий Бабуров (уточняется)

### 31 марта - Как AGI причинно-следственные связи искать будет - Николай Рабчевский, Евгений Витяев (?), Антон Колонин (уточняется)
...
### 21 апреля - Про мышление в преломлении различных перспектив - Евгений Витяев (уточняется)

### 28 апреля - Теория Эмоционально Обусловленного Сознания, как основа построения Сильного ИИ - Иван Григорук (уточняется)

### 5 мая - Алгоритм - Знание - AGI: Путь к теории - Алексей Борисов (уточняется)

- https://gitlab.com/aiborisov84/ai_borisov_CIT/-/blob/master/book/BookPractice/article_007_TheoryOverview/content.md

### 12 мая - Эмерджентный интеллект - Петр Скобелев (уточняется)

### 19 мая - Этичность и Интерпретируемость AGI - мифы, болтовня или суровая необходимость - модератор Игорь Пивоваров (уточняется)
