...
### 13 апреля 2023 - RNSH-память как основа архитектуры разумных машин - Алекс Леви (UX-дизайнер, программист, AGI-энтузиаст, главный дизайнер ВТБ)
...
### 18 мая 2023 - Новые приключения в интерепретируемом NLP - Антон Колонин (кандидат технических наук, ведущий специалист НГУ, основатель Aigents, архитектор SingularityNET) - уточняется
