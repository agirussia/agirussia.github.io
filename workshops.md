...
### 21 мая 2026 18:00 мск - Элементарный универсальный цикл непрерывного внимания как новая модель для вычисления обобщений мета-аттрактора - Алексей Кабанов (BTR R&D) - уточняется
