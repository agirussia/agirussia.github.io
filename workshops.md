...
### 20 июля 2023 - летние каникулы

### 27 июля 2023 - Объединенный семинар [КОНИ](https://seminar.bicalab.org/) и AGIRussia
- Будущее AGI (панельная дискуссия) - Константин Воронцов, Игорь Пивоваров, Михаил Киселев, Александр Болдачев, модератор - Алексей Самсонович
  - Должен ли искусственный интеллект (ИИ) быть наделен набором высших когнитивных функций, которые сегодня отличают человека как от других животных, так и от машин? А именно: свобода воли, человекоподобное «я» и личность, целеполагание и свободное рассуждение о своих целях, о системе ценностей, морали и идеологии, духовные идеалы и вера, мотивация, лидерские навыки, высшие эмоции и способность управлять ими, способность моделировать мысли и чувства людей, инсайт, креативность и активное обучение на уровне человека, а также другие сопутствующие способности?
  - В зависимости от ответа на первый вопрос: если да, то каким образом должны регулироваться права и возможности ИИ в обществе будущего? Будет ли ИИ иметь равный с человеком статус в обществе, а в перспективе – неизбежно статус выше человека? Если нет, то каким образом этого удастся избежать? Будут ли некоторые виды и функции ИИ запрещены, и каким образом удастся соблюсти эти запреты? А когда запреты будут нарушены, не превратится ли ИИ из «изгоя» в «высшую расу» по стандартному сценарию, с последующим вырождением человека в обезьяну?
  - Человек уже имеет признаки вырождения. В то же время, возможности человека, вооруженного ИИ, невероятно растут. Их будущий уровень и потенциальный вред, который они могут принести, трудно переоценить. По сути человек — все еще обезьяна, не готовая к новым возможностям. Поэтому возникает вопрос: каким образом должны будут регулироваться права и возможности человека в обществе будущего? Кто или что будет их регулировать, если не ИИ? А если так, то не прийдем ли мы к Матрице, то есть, к неофашизму? Во что тогда может выродиться человек? Может, прогресс следует заморозить сейчас, откатив человечество назад, в эпоху средневековья как минимум? Или же человек должен слиться с ИИ в форме некоего бесполого трансгуманоида, в котором именно ИИ-компонент станет гарантом благонамеренности и нравственной целостности?
- Когнитивный подход к моделированию социальной эмоциональности и эмоционального интеллекта (доклад) - Алексей Самсонович
   
### 3 августа 2023 - летние каникулы

### 10 августа 2023 - Модель индивидуального и коллективного сознания на основе принципов социального доказательства и свободной энергии - Антон Колонин (основатель проекта Aigents, ведущий специалист НГУ) - уточняется
...
### 17 августа 2023 - ... - уточняется

### 24 августа 2023 - Лабораторный измерительный практикум: интеллект = знания + обучаемость? - Юрий Бабуров (CTO компании DreamDocs, преподаватель НГУ) - уточняется

### 31 августа 2023 - Искусственный интеллект с эмоциями и моделью разума или что нужно знать, чтобы создать ChatGPT - Владимир Радкевич (Технический директор ЕЮС Тех) - уточняется

### 7 сентября 2023 - Новое поколение DLT: Trusted Semantic Network (DLT+Semantic+LLM) - Александр Болдачев (философ, cистемный архитектор IT-проектов: блокчейн, семантические технологии) - уточняется
- https://hub.forklog.com/semanticheskij-web-chto-takoe-sobytijnaya-semantika-i-kak-ona-prishla-iz-filosofii-v-it/

### 14 сентября 2023 - Как мультимодальные модели учатся понимать текст, картинки, видео и аудио - Андрей Кузнецов (исполнительный директор по исследованию данных Sber AI) - уточняется

### 21 сентября 2023 - ... - уточняется

### 28 сентября 2023 - ИИ и блокчейн - будущее или хайп? (круглый стол) - Александр Нам, Андрей Нечесов, Антон Колонин, приглашаются спикеры ... - уточняется
- А.Нам: Бизнес-кейсы применения ИИ и блокчейн
- [С.Гончаров, А.Нечесов: Аксиоматизация теории блокчейна](https://www.mdpi.com/2227-7390/11/13/2966)
- [А.Колонин: Будущее блокчейна и Репутационный консенсус](https://dzen.ru/a/X9JKFEkHMFmDtQfS)
- приглашаются спикеры ...

### 5 октября 2023 - GPT + планирование = AGI? - Юрий Бабуров (CTO компании DreamDocs, преподаватель НГУ) - уточняется
